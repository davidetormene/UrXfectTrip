        ...
        <section class="clean-block clean-pricing dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Packages we current offer</h2>
                    <p>Before the Log in, this shall be placeholders which showcase the possibe options. After the Log In customers can <strong>select (checkbox) and book</strong> his/her trips. We might not even need the <strong>From</strong> and <strong>To </strong>because
                        our planned trips are from Basel to Basel. I think we can import the description of the three trips from the "public page" and remove the description column.</p>
                </div>
            </div>
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Packages currently available</h2>
                    <form>
                        <div class="form-group"><select class="form-control" id="month"><optgroup label="Select a Month"><option value="1" selected="">January</option><option value="2">February</option><option value="3">March</option><option value="4">April</option><option value="5">May</option><option value="6">June</option><option value="7">July</option><option value="8">August</option><option value="9">September</option><option value="10">October</option><option value="11">November</option><option value="12">December</option></optgroup></select>
                            <select
                                class="form-control" id="region">
                                <optgroup label="Packages">
                                    <option value="1" selected="">trip to France</option>
                                    <option value="2">trip to Germany</option>
                                    <option value="14">trip to Switzerland</option>
                                </optgroup>
                                </select><button class="btn btn-primary float-left" type="button">Submit</button></div>
                    </form>
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="btn-group" role="group"><button class="btn btn-primary" type="button"><i class="fa fa-edit"></i></button><button class="btn btn-primary" type="button"><i class="fa fa-trash"></i></button></div>
                                    </td>
                                </tr>
                                <tr>
                                    <td>Cell 3</td>
                    ...
                    <div class="btn-group float-left" role="group"><button class="btn btn-primary" type="button">Book</button><button class="btn btn-primary" type="button"><i class="fa fa-plus"></i></button></div>
                </div>
            </div>
        </section>
    </main>
