...
<body>
    ...
    <main class="page landing-page">
        <section class="clean-block clean-hero" style="background-image: url(&quot;assets/img/Unknown.jpg&quot;);color: rgba(9, 162, 255, 0.85);">
            <div class="text">
                <h2>Chose among 3 fabolous Packages</h2>
                <p>You can chose among 3 packages, all starting from Basel, at a convenient price!</p><a class="btn btn-outline-light btn-lg" role="button" href="our-packages.php">Take a pick at our Packages!</a></div>
        </section>
        <section class="clean-block features">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Plan and Experience your Perfect Trip</h2>
                    <p>With UrXfectTrip you can plan and manage in detail your personal trip.</p>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-5 feature-box"><i class="icon-star icon"></i>
                        <h4>Chose among various packages</h4>
                    </div>
                    <div class="col-md-5 feature-box"><i class="icon-pencil icon"></i>
                        <h4><strong>View your Itineraries</strong></h4>
                    </div>
                    <div class="col-md-5 feature-box"><i class="icon-screen-smartphone icon"></i>
                        <h4>Check the trip expenses as you go</h4>
                    </div>
                    <div class="col-md-5 feature-box"><i class="icon-refresh icon"></i>
                        <h4>Print a financial overview of your costs</h4>
                    </div>
                </div>
            </div>
        </section>
