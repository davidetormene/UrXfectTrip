        ...
        <section class="clean-block clean-pricing dark">
            <div class="container">
                <div class="block-heading">
                    <h2 class="text-info">Itineraries we currently offer</h2>
                    <p id="1">Before the Log in, this shall be <strong>placeholders</strong> which only showcase the possibe options, the only link is the Register Link. After the Log In customers can&nbsp;select (checkbox) and book&nbsp;his/her trips. test</p>
                </div>
                <div class="row justify-content-center">
                    <div class="col-md-5 col-lg-4">
                        <div class="clean-pricing-item">
                            <div class="heading">
                                <h3>France package</h3>
                            </div>
                            <p>Description package 1</p>
                            <p>Description package 1</p>
                            <p>Description package 1</p>
                            <div class="price"></div><a class="btn btn-outline-primary btn-block" role="button" href="registration.php">Register</a></div>
                    </div>
                    <div class="col-md-5 col-lg-4">
                        <div class="clean-pricing-item">
                            <div class="ribbon"><span>Most requested</span></div>
                            <div class="heading">
                                <h3>Switzerland package</h3>
                            </div>
                            <p>Description package 2</p>
                            <p>Description package 2</p>
                            <p>Description package 2</p>
                            <div class="price"></div><a class="btn btn-primary btn-block" role="button" href="registration.php">Register</a></div>
                    </div>
                    <div class="col-md-5 col-lg-4">
                        <div class="clean-pricing-item">
                            <div class="heading">
                                <h3>Germany package</h3>
                            </div>
                            <p>Description package 2</p>
                            <p>Description package 2</p>
                            <p>Description package 2</p>
